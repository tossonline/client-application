-- =============================================
-- Database Settings
-- Purpose: Set up database-level configuration and settings for dbAffiliate_Analytics
-- Script Type: runBeforeUp - runs before all migration scripts
-- =============================================
...
-- Set database compatibility level to latest
ALTER DATABASE [dbAffiliate_Analytics] SET COMPATIBILITY_LEVEL = 160; -- SQL Server 2022

-- Configure memory optimized settings for high-volume analytics
ALTER DATABASE [dbAffiliate_Analytics] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT = ON;

-- Set optimal database settings for analytics workload
ALTER DATABASE [dbAffiliate_Analytics] SET DELAYED_DURABILITY = ALLOWED;

PRINT 'Database settings configured successfully for dbAffiliate_Analytics';
PRINT 'Optimized for analytics workload with high-volume event processing';