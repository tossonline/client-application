...
SELECT @CURRENT_SCHEMA_VERSION = [Version]
FROM [HangFire].[Schema];

PRINT 'Current Hangfire schema version: ' +
      CASE WHEN @CURRENT_SCHEMA_VERSION IS NULL THEN 'none' ELSE CONVERT(nvarchar, @CURRENT_SCHEMA_VERSION) END;
...
IF @CURRENT_SCHEMA_VERSION IS NULL
    BEGIN
        ...
        ALTER TABLE [HangFire].[State]
            ADD CONSTRAINT [FK_HangFire_State_Job] FOREIGN KEY ([JobId])
        ...
        ALTER TABLE [HangFire].[JobParameter]
            ADD CONSTRAINT [FK_HangFire_JobParameter_Job] FOREIGN KEY ([JobId])
                REFERENCES [HangFire].[Job] ([Id])
                ON UPDATE CASCADE
                ON DELETE CASCADE;
...
IF @CURRENT_SCHEMA_VERSION = 1
    BEGIN
        ...
        ALTER TABLE [HangFire].[Counter]
            ALTER COLUMN [Value] SMALLINT NOT NULL;
        ...
        ALTER TABLE [HangFire].[Server]
            ALTER COLUMN [LastHeartbeat] DATETIME NOT NULL;
...
IF @CURRENT_SCHEMA_VERSION = 4
    BEGIN
        ...
        ALTER TABLE [HangFire].[JobQueue]
            ALTER COLUMN [Queue] NVARCHAR(50) NOT NULL;
        ...
        ALTER TABLE [HangFire].[Server]
            ALTER COLUMN [Id] NVARCHAR(200) NOT NULL;
        PRINT 'Modified [HangFire].[Server].[Id] length to 200';

        ALTER TABLE [HangFire].[Server]
            ADD CONSTRAINT [PK_HangFire_Server] PRIMARY KEY CLUSTERED
                (
                 [Id] ASC
                    );
...
ELSE
    IF @CURRENT_SCHEMA_VERSION = 5
        BEGIN
            ...
            SELECT @dropIndexSql +=
                   N'DROP INDEX ' + QUOTENAME(SCHEMA_NAME(o.[schema_id])) + '.' + QUOTENAME(o.name) + '.' +
                   QUOTENAME(i.name) + ';'
            ...
            ALTER TABLE [HangFire].[JobParameter]
                DROP CONSTRAINT [FK_HangFire_JobParameter_Job];
            PRINT 'Dropped constraint [FK_HangFire_JobParameter_Job]';

            ALTER TABLE [HangFire].[State]
                DROP CONSTRAINT [FK_HangFire_State_Job];
            ...
            ALTER TABLE [HangFire].[Job]
                ALTER COLUMN [StateId] BIGINT NULL;
            PRINT 'Modified [Job].[StateId] type to BIGINT';

            ALTER TABLE [HangFire].[JobParameter]
                ALTER COLUMN [JobId] BIGINT NOT NULL;
            ...
            ALTER TABLE [HangFire].[AggregatedCounter]
                ADD CONSTRAINT [PK_HangFire_CounterAggregated] PRIMARY KEY CLUSTERED (
                                                                                      [Key] ASC
                    );
            ...
            ALTER TABLE [HangFire].[Hash]
                ADD CONSTRAINT [PK_HangFire_Hash] PRIMARY KEY CLUSTERED (
                                                                         [Key] ASC,
                                                                         [Field] ASC
                    );
            ...
            ALTER TABLE [HangFire].[Job]
                ADD CONSTRAINT [PK_HangFire_Job] PRIMARY KEY CLUSTERED ([Id] ASC);
            PRINT 'Re-created constraint [PK_HangFire_Job]';

            ALTER TABLE [HangFire].[JobParameter]
                ADD CONSTRAINT [PK_HangFire_JobParameter] PRIMARY KEY CLUSTERED (
                                                                                 [JobId] ASC,
                                                                                 [Name] ASC
                    );
            ...
            ALTER TABLE [HangFire].[JobQueue]
                ADD CONSTRAINT [PK_HangFire_JobQueue] PRIMARY KEY CLUSTERED (
                                                                             [Queue] ASC,
                                                                             [Id] ASC
                    );
            ...
            ALTER TABLE [HangFire].[List]
                ADD CONSTRAINT [PK_HangFire_List] PRIMARY KEY CLUSTERED (
                                                                         [Key] ASC,
                                                                         [Id] ASC
                    );
            ...
            ALTER TABLE [HangFire].[Set]
                ADD CONSTRAINT [PK_HangFire_Set] PRIMARY KEY CLUSTERED (
                                                                        [Key] ASC,
                                                                        [Value] ASC
                    );
            ...
            ALTER TABLE [HangFire].[State]
                ADD CONSTRAINT [PK_HangFire_State] PRIMARY KEY CLUSTERED (
                                                                          [JobId] ASC,
                                                                          [Id]
                    );
...
ELSE
    IF @CURRENT_SCHEMA_VERSION = 7
        BEGIN
            ...
            ALTER TABLE [HangFire].[Server]
                ADD CONSTRAINT [PK_HangFire_Server] PRIMARY KEY CLUSTERED ([Id] ASC);
            PRINT 'Re-created constraint [PK_HangFire_Server]';
            ...
            SELECT @dropIndexSql2 += N'ALTER TABLE' + QUOTENAME(SCHEMA_NAME(o.[schema_id])) + '.' + QUOTENAME(o.name) +
            ...
            ALTER TABLE [HangFire].[Counter]
                ADD CONSTRAINT [PK_HangFire_Counter] PRIMARY KEY CLUSTERED (
                                                                            [Key] ASC,
                                                                            [Id] ASC
                    );
